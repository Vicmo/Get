                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <ul class="nav nav-tabs bar_tabs ">
                      <li id="registro" class="active"><a data-toggle="tab" href="#home">Consultar Gestores</a></li>
                      <li id="consulta"><a data-toggle="tab" href="#menu2"> Consultar Talentos</a></li>
                    </ul>
                    <div class="tab-content">
                      <div id="home" class="tab-pane fade in active">
                        <br>
                        <h2 class="text-center"><b>Gestores</b></h2>
                        <br>
                        <div class="row topinput">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="item form-group" style="margin-left: 30%">
                              ...
                              <select id="txtnodotbgestor" class="form-control col-md-9 col-xs-12" name="txtnodotbgestor" required="">
                        ...
                        <br><br>
                          <div class="form-group">
                            <center><button type="button" id="btnconsultagestor" class="btn btn-success">Consultar Gestores</button>
                          </div>
                        <br><br>
                        <table class="table table-striped jambo_table bulk_action dt-responsive no-wrap " id="tblgestor"  width="100%"  style="visibility: hidden;">
                          <thead>
                            <tr>
                      ...
                      <div id="menu2" class="tab-pane fade">
                        ...
                        <div class="tab-content">
                          <div id="consultatalento" class="tab-pane fade in active">
                            ...
                            <br><br>
                            <div class="form-group">
                               <center><button type="button" id="btnconsultatalento" class="btn btn-success">Consultar Talentos</button>
                            </div>
                            <br><br>
                            <table class="table table-striped jambo_table bulk_action dt-responsive no-wrap " id="tbltalento"  width="100%" style="visibility: hidden;">
                              <thead>
                                <tr>
                                   <th>Tipo Documento</th>
                                   <th>Talento</th>
                          ...
                          <div id="consultatalentogestor" class="tab-pane fade">
                            ...
                            <br><br>
                              ...
                              <br><br>
                              <table class="table table-striped jambo_table bulk_action dt-responsive no-wrap " id="tbltalentogestor"  width="100%" style="visibility: hidden;">
                                <thead>
                                  <tr>
                                    <th>Tipo Documento</th>
                                    <th>Talento</th>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" id="modaltalentopornodo">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <br>
                          <table class="table table-striped jambo_table bulk_action dt-responsive no-wrap" id="tblmodaltalentonodo">
                          </table>
                      </div>
                    </div>
                  </div>
...
<!-- fin modal-->
 ...
 <script src="<?php echo URL; ?>js/usuarioadminajax.js"></script>
