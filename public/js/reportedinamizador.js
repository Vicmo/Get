       ...
       $.ajax({
         ...
         $.ajax({
          ...
          $.ajax({
           dataType:'json',
           type:'post',
           url:uri+"reportes/reporteadmintodo/"+fi+"/"+ff+"/"+idnodo
         }).done(function(adm) {
          $.ajax({
           dataType:'json',
           type:'post',
...
$.ajax({
  ...
  $.ajax({
    dataType:'json',
    type:'post',
    url:uri+"reportes/reportemantenimientolinea/"+fi+"/"+ff+"/"+l+"/"+idnodo
  }).done(function(man) {
        ...
        $.ajax({
          dataType:'json',
          type:'post',
          url:uri+"reportes/reportematerialeslinea/"+fi+"/"+ff+"/"+l+"/"+idnodo
        }).done(function(mat) {
        var mmateriales = 0;
        $.each(mat, function(i, item) {
          mmateriales +=(item.materiales*item.tiempo);
        ...
        $.ajax({
          dataType:'json',
          type:'post',
          url:uri+"reportes/reporteasesoriaslinea/"+fi+"/"+ff+"/"+l+"/"+idnodo
        }).done(function(as) {
         ...
         $.ajax({
          dataType:'json',
          type:'post',
          url:uri+"reportes/reporteadminlinea/"+fi+"/"+ff+"/"+l+"/"+idnodo
        }).done(function(adm) {
